...
const dataList = [   
      ...
      // Filter to only include jurisdictions with less than 5 institutions
      const filteredData = groupedData.filter(group => group.institutions.length < 5);
      ...
      const x0 = d3.scaleBand()
          ...
          .paddingInner(0.1)
          .domain(filteredData.map(group => group.jurisdiction));
      ...
      const y = d3.scaleLinear()
          ...
          .domain([0, d3.max(filteredData, d => d.institutions.length) + 1]);
      ...
      svg.append("text")
          ...
          .text("Institutions with Subject Matter Jurisdictions with Less Than 5 Institutions");
